...
const mapStateToProps = ({productsInCart}: State) => ({
  productsInCart,
});
...
function CartPage({productsInCart}: ConnectedComponentProps):JSX.Element {
  ...
  return (
    <>
          ...
          <div className="container">
            ...
            <div className="cart">
              {productsInCart?.slice().map((product) => (
                <ProductInCart key={product.id} product={product} setIsModalProductDeleteVisible={setIsModalProductDeleteVisible} setProductToDelete={setProductToDelete}/>
              ))}
      ...
      {isModalProductDeleteVisible && <ModalCartDelete productToDelete={productToDelete} setIsModalProductDeleteVisible={setIsModalProductDeleteVisible}/>}
    </>
  );
}
